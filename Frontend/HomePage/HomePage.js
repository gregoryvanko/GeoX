class HomePage{
    ...
    RenderPosts (Data, DivId){
        Data.forEach(element => {
            ...
            // Add Info
            DivPost.appendChild(this.RenderTitre(element.Name))
            // Add mesure
            DivPost.appendChild(this.RenderMesure(element.Description, element.Date, element.Length, element.InfoElevation))
            // Add image
    ...
    RenderMesure(PsotDescription= "Description", PostDate= null, Length = null, InfoElevation = null){
        ...
        DivContent.appendChild(this.DrawDataInfo(Length, "Km", this.GetSvgMesureDiv()))
        DivContent.appendChild(this.DrawVerticalLine())
        DivContent.appendChild(this.DrawDataInfo(InfoElevation.ElevCumulP, "m", this.GetSvgElevationPlusDiv()))
        DivContent.appendChild(this.DrawVerticalLine())
        DivContent.appendChild(this.DrawDataInfo(InfoElevation.ElevCumulM, "m", this.GetSvgElevationMoinsDiv()))
        DivContent.appendChild(this.DrawVerticalLine())
        DivContent.appendChild(this.DrawDataInfo(InfoElevation.ElevMax, "m", this.GetSvgElevationMaxDiv()))
        DivContent.appendChild(this.DrawVerticalLine())
        DivContent.appendChild(this.DrawDataInfo(InfoElevation.ElevMin, "m", this.GetSvgElevationMinDiv()))

class GeoXMap {
    ...
    LoadViewMap(){
        ...
        this._DivApp.appendChild(CoreXBuild.ButtonLeftAction(this.ShowTrackInfoBox.bind(this), "ButtonShowTrackInfo", `<img src="${Icon.OpenPanel()}" alt="icon" width="25" height="25">`))
